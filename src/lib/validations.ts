...
export const createTierSchema = z.object({
  ...
  minimumPrice: z.number().min(1, 'Minimum price must be at least $1').max(1000, 'Maximum price is $1000')
})
...
export const updateSubscriptionSchema = z.object({
  amount: z.number().min(1, 'Amount must be at least $1').max(1000, 'Maximum amount is $1000').optional()
})
