        ...
        >
          <motion.div variants={itemVariants} className="max-w-4xl mx-auto">
            ...
            >
              ...
              <button className="group inline-flex items-center px-8 py-4 text-lg font-semibold text-white border-2 border-white/30 rounded-full hover:border-white/50 hover:bg-white/10 transition-all backdrop-blur-sm animate-pulse-glow">
          ...
          >
            {[
              { number: 15000, suffix: "+", label: "Active Artists" },
              { number: 250000, suffix: "+", label: "Superfans" },
              { number: 5, suffix: "M+", prefix: "$", label: "Artist Earnings" }
            ].map((stat, index) => (
              <motion.div
                key={index}
                variants={itemVariants}
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { name: "Sarah Chen", role: "Music Artist", quote: "This platform transformed my career!" },
              { name: "Marcus Rodriguez", role: "Digital Artist", quote: "Amazing analytics and insights." },
              { name: "Luna Williams", role: "Content Creator", quote: "Security features give me peace of mind." }
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center px-6 relative">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Join thousands of creators who have already discovered the power of direct fan connections. Start building your sustainable income today.
          </p>
