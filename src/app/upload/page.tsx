          ...
          <div className="flex">
            ...
            <div className="ml-4">
              ...
              <div className="text-sm text-blue-800 dark:text-blue-300 space-y-2">
                <p>• <strong>High-quality content:</strong> Ensure your files are high resolution and good quality</p>
                <p>• <strong>Appropriate titles:</strong> Use descriptive, engaging titles for better discoverability</p>
                <p>• <strong>File sizes:</strong> Images (10MB), Audio (100MB), Video (500MB), Documents (50MB)</p>
                <p>• <strong>Supported formats:</strong> JPG/PNG, MP3/WAV, MP4/MOV, PDF/DOC</p>
                <p>• <strong>Public vs Private:</strong> Public content is visible to everyone, private content requires tier subscription</p>
              </div>
            </div>
          </div>
        </div>
