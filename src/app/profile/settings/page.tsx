...
export default function ProfileSettingsPage() {
  ...
  const { loading: updatingNotifications, mutate: updateNotifications } = useApiMutation<
    any,
  ...
  const { loading: changingPassword, mutate: changePassword } = useApiMutation<
    any,
    typeof passwordForm
                  ...
                  <div className='space-y-4'>
                    ...
                    <div className='flex items-center justify-between'>
                      <div>
                        ...
                        <p className='text-sm text-gray-600'>
                          Updates about your subscriptions and billing
                        </p>
                      </div>
                      <label className='relative inline-flex items-center cursor-pointer'>
                        <input
                          ...
                          onChange={e =>
                            handleNotificationChange('subscriptions', e.target.checked)
                          }
                          className='sr-only peer'
                        />
                        <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-indigo-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-indigo-600"></div>
                    ...
                    <div className='flex items-center justify-between'>
                      <div>
                        ...
                        <p className='text-sm text-gray-600'>
                          Notifications when artists you follow post new content
                        </p>
                      </div>
                      <label className='relative inline-flex items-center cursor-pointer'>
                        <input
                    ...
                    <div className='flex items-center justify-between'>
                      <div>
                        ...
                        <p className='text-sm text-gray-600'>
                          Updates about platform features and promotions
                        </p>
                      </div>
                      <label className='relative inline-flex items-center cursor-pointer'>
                        <input
          ...
          <div>
            ...
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 text-center'>
              ...
              <p className='text-gray-600 mb-4'>
                Access Stripe Customer Portal to manage your payment methods, view invoices, and
            ...
            <nav className='space-y-1'>
              {TABS.map(tab => {
                ...
                return (
                  ...
                  >
                    <Icon
                      className={`mr-3 h-5 w-5 ${isActive ? 'text-indigo-500' : 'text-gray-400'}`}
                    />
                    {tab.label}
                  </button>
                );
