      ...
      <section className="py-24 bg-gray-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { title: "Flexible Monetization", desc: "Set your own subscription prices with daily payouts.", icon: "💰" },
              { title: "Superfan Communities", desc: "Build exclusive communities around your content.", icon: "👥" },
              { title: "Secure & Private", desc: "Enterprise-grade security with content protection.", icon: "🛡️" },
              { title: "Advanced Analytics", desc: "Deep insights into your audience and revenue trends.", icon: "📊" }
            ].map((feature, index) => (
              <motion.div
                key={index}
