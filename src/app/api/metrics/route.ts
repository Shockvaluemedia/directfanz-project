...
async function updateBusinessMetrics(): Promise<void> {
  try {
    ...
    businessMetrics.updateARPU('30d', 'all_users', 25.50 + secureRandomFloat(10));
    ...
    businessMetrics.updateARPU('90d', 'creators', 42.50 + secureRandomFloat(20));
    businessMetrics.updateARPU('90d', 'subscribers', 82.75 + secureRandomFloat(30));
    businessMetrics.updateARPU('90d', 'free_users', 0);
    
    businessMetrics.updateARPU('365d', 'all_users', 21.80 + secureRandomFloat(10));
    businessMetrics.updateARPU('365d', 'creators', 40.25 + secureRandomFloat(20));
    businessMetrics.updateARPU('365d', 'subscribers', 78.90 + secureRandomFloat(30));
