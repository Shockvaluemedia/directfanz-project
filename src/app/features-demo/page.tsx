      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed'>
            Explore all the features and capabilities of the Direct Fan Platform. Click on any
            feature to test it live.
          </p>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
          {featureSections.map((section, sectionIndex) => (
            ...
            >
              ...
              <div
                className={`absolute inset-0 bg-gradient-to-br ${section.color} opacity-0 group-hover:opacity-5 transition-opacity duration-300 rounded-2xl`}
              ></div>

              {/* Icon */}
              <div
                className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br ${section.color} mb-6 transform group-hover:scale-110 transition-transform duration-300`}
              >
              ...
              {/* Hover Effect Border */}
              <div
                className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${section.color} opacity-0 group-hover:opacity-20 transition-opacity duration-300 -z-10 blur-xl`}
              ></div>
            </div>
          ))}
        </div>
