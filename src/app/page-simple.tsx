            ...
            {[
              {
                ...
                desc: 'Set your own subscription prices with daily payouts through Stripe.',
              },
              {
                title: 'Superfan Communities',
                desc: 'Build exclusive communities around your content with private messaging.',
              },
              {
                title: 'Secure & Private',
                desc: 'Enterprise-grade security with end-to-end encryption and content protection.',
              },
              {
                title: 'Advanced Analytics',
                desc: 'Deep insights into your audience, revenue trends, and content performance.',
              },
            ].map((feature, index) => (
              <div
                key={index}
