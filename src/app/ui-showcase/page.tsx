          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div>
                  <h5 className="text-sm font-medium mb-3 text-gray-700 dark:text-gray-300">Content Card</h5>
                  <ContentCardSkeleton />
                </div>
                <div>
                  <h5 className="text-sm font-medium mb-3 text-gray-700 dark:text-gray-300">User Profile</h5>
                  <UserProfileSkeleton />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-6">
                <div>
                  <h5 className="text-sm font-medium mb-3 text-gray-700 dark:text-gray-300">Cards Layout</h5>
