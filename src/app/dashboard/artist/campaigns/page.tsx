                ...
                <CardContent className="pt-6">
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-2xl font-bold text-gray-900 dark:text-white">
                        {campaigns.reduce((sum, c) => sum + c.challenges.filter(ch => ch.status === 'ACTIVE').length, 0)}
                      </p>
                    </div>
                  </div>
                </CardContent>
                  ...
                  <Card key={campaign.id} className="hover:shadow-lg transition-shadow cursor-pointer">
                    <CardHeader className="pb-3">
                      <div className="flex justify-between items-start">
                        ...
                        <Badge className={`ml-2 ${STATUS_COLORS[campaign.status as keyof typeof STATUS_COLORS]}`}>
                          {campaign.status}
                        </Badge>
                      </div>
                    </CardHeader>
