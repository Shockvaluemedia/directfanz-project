...
export function useConditionalRender() {
  ...
  const renderForArtist = (component: React.ReactNode) => renderForRole(UserRole.ARTIST, component);

  const renderForFan = (component: React.ReactNode) => renderForRole(UserRole.FAN, component);
