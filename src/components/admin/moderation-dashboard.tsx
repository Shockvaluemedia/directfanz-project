...
export default function ModerationDashboard() {
  ...
  } = useApi<ReportsResponse>(`/api/moderation/reports?status=${selectedStatus}&priority=${selectedPriority}`, {
    immediate: true
  })
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg space-y-2">
                  <p><strong>Type:</strong> {selectedReport.targetType}</p>
                  <p><strong>Reason:</strong> {selectedReport.reason.replace(/_/g, ' ')}</p>
              ...
              <div className="flex space-x-3">
                ...
                <button
                  onClick={() => handleUpdateReport('content_removal', 'Content removed for policy violation')}
                  disabled={updatingReport}
                ...
                <button
                  onClick={() => handleUpdateReport('dismiss', 'Report reviewed and dismissed - no violation found')}
                  disabled={updatingReport}
