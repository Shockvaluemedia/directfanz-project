      ...
      <div className='max-w-7xl mx-auto px-6 relative'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed'>
            Free to join for artists and fans. You only pay when you earn, with daily payouts and no
            hidden fees.
          </p>
        </div>
            ...
            >
              ...
              <div className='text-center mb-8'>
                ...
                <div className='flex items-center justify-center mb-4'>
                  <span
                    className={`text-5xl font-bold bg-gradient-to-r ${info.color} bg-clip-text text-transparent`}
                  >
                    {info.price}
                  </span>
              ...
              <div className='space-y-3 mb-8'>
                {info.features.map((feature, featureIndex) => {
                  ...
                  return (
                    <div
                      key={featureIndex}
                      className={`flex items-start ${isSubPoint ? 'ml-6' : ''}`}
                    >
                      {!isHeader && !isSubPoint && (
                      ...
                      <span
                        className={`text-gray-700 ${isHeader ? 'font-semibold text-gray-900' : ''}`}
                      >
                        {feature}
                      </span>
                    </div>
        ...
        <div className='mb-16'>
          ...
          <div className='text-center mb-12'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              Stop grinding for millions of views and streams for pennies. Your content is worth
              more than $0.003 per play.
            </p>
          </div>
          ...
          <div className='grid lg:grid-cols-3 gap-8 mb-12'>
            {Object.entries(revenueComparisons).map(([tier, data]) => (
              ...
              >
                ...
                <div className='absolute -top-4 left-1/2 transform -translate-x-1/2'>
                  <div
                    className={`bg-gradient-to-r ${data.gradient} text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg`}
                  >
                    {data.scenario}
                  </div>
                </div>
                ...
                <div className='text-center mb-6 pt-4'>
                  ...
                  <div className='text-sm text-green-600 font-semibold'>
                    You keep $
                    {(parseInt(data.monthlyRevenue.replace(/[^0-9]/g, '')) * 0.8).toLocaleString()}
                  </div>
                </div>
                ...
                <div className='space-y-3 mb-6'>
                  <div className='bg-green-50 rounded-lg p-3'>
                    ...
                    <div className='text-sm text-green-700'>
                      {data.fanCount} paying {data.avgSpend}
                    </div>
            ...
            <div className='grid md:grid-cols-4 gap-6'>
              {[
                ...
                { month: 'Month 3', fans: '75 fans', earnings: '$600', note: 'Building momentum' },
                {
                  ...
                  fans: '200 fans',
                  earnings: '$1,280',
                  note: 'Sustainable income',
                },
                {
                  month: 'Year 1',
                  fans: '500+ fans',
                  earnings: '$4,000+',
                  note: 'Life changing money',
                },
              ].map((stage, i) => (
          ...
          <div className='bg-gradient-to-r from-red-500 to-pink-600 rounded-2xl p-8 text-white text-center'>
            ...
            <p className='text-lg mb-6 opacity-90'>
              While YouTube pays $0.003 per view and Spotify pays $0.003 per stream, your fans are
              willing to pay $10-25 for your content.
              <br />
              You just need a platform that doesn't steal 50-70% of your earnings.
            </p>
            <div className='text-center'>
              <div className='text-sm opacity-75 mb-2'>
                Daily payouts • 80% revenue share • No algorithm games
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='text-center mt-16'>
          ...
          <p className='text-gray-600 mb-6'>
            Join thousands of creators already building their income on our platform.
          </p>
          <Link
            href='/auth/signup'
