...
const testimonials = [
  {
    ...
    avatar:
      'https://images.unsplash.com/photo-1494790108755-2616b612b830?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80',
    rating: 5,
  },
  {
      ...
      <div className='max-w-7xl mx-auto px-6'>
        ...
        >
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            Join a thriving community of creators who are building sustainable income streams and
        ...
        >
          ...
          <p className='text-lg text-gray-600 max-w-2xl mx-auto'>
            Real stories from creators who have transformed their creative careers with our
            platform.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className='flex flex-wrap items-center justify-center space-x-8 opacity-60'>
            {['Spotify', 'SoundCloud', 'Instagram', 'TikTok', 'YouTube', 'Twitch'].map(
              (platform, index) => (
                <div
                  key={index}
