...
const testimonials = [
  {
    ...
    role: 'Music Artist',
    content:
      'This platform completely transformed how I connect with my fans. The direct messaging feature and exclusive content tiers have increased my monthly revenue by 400%.',
    rating: 5,
    revenue: '$12K/month',
  ...
  },
  {
    ...
    role: 'Digital Artist',
    content:
      'The analytics dashboard gives me incredible insights into my audience. I can see exactly what content resonates and optimize my strategy accordingly.',
    rating: 5,
    revenue: '$8.5K/month',
  ...
  },
  {
    ...
    content:
      "The security features give me peace of mind. I can share exclusive content knowing it's protected, and the daily payouts help me manage my finances better.",
    rating: 5,
    revenue: '$15K/month',
  ...
  },
  {
    ...
    content:
      'Building a sustainable income from podcasting seemed impossible until I found this platform. My listeners love the exclusive behind-the-scenes content.',
    rating: 5,
    revenue: '$6.2K/month',
  ...
  },
  {
    ...
    role: 'Visual Artist',
    content:
      'The community features are amazing! My fans feel more connected to my creative process, and the tiered subscription model lets me offer different levels of access.',
    rating: 5,
    revenue: '$9.8K/month',
      ...
      <div className='max-w-6xl mx-auto px-6 relative'>
        ...
        >
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            Join thousands of creators who have transformed their creative careers and built
                ...
                <div className='grid md:grid-cols-3 gap-8 items-center'>
                  ...
                  <div className='md:col-span-2'>
                    ...
                    <div className='flex items-center space-x-4'>
                      <div
                        className={`w-16 h-16 rounded-full bg-gradient-to-br ${testimonials[currentIndex].gradient} flex items-center justify-center text-white font-bold ring-4 ring-white shadow-lg`}
                      >
                  ...
                  <div className='text-center'>
                    <div className='bg-gradient-to-br from-green-400 to-emerald-500 rounded-2xl p-6 text-white transform rotate-3 hover:rotate-0 transition-transform duration-300'>
                      ...
                      <div className='text-3xl font-bold'>{testimonials[currentIndex].revenue}</div>
