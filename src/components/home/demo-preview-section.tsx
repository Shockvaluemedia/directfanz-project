            ...
            <div key={i} className="flex items-center justify-between p-4 bg-white border rounded-lg">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <div className="text-sm text-gray-600">{release.sales} sales • {release.price}</div>
                </div>
              </div>
              <div className="text-right">
      ...
      <div className="p-6">
        <div className="grid gap-6">
          {[
            ...
            <div key={i} className="border rounded-lg p-6 hover:shadow-lg transition-all duration-300">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center">
                  <div className={`w-16 h-16 rounded-full bg-gradient-to-br ${artist.gradient} flex items-center justify-center text-white font-bold text-lg`}>
                    {artist.avatar}
                  </div>
                  <div className="ml-4">
      ...
      <div className="p-6">
        ...
        <div className="flex items-center mb-6 p-4 bg-gray-50 rounded-lg">
          ...
          <div className="ml-4 flex-1">
            ...
            <div className="flex items-center mt-1">
              <span className="text-sm bg-green-100 text-green-700 px-2 py-1 rounded">Pay-What-You-Want</span>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          {/* CTA */}
          <button 
            onClick={() => {/* Demo purchase completion */}}
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Don't just take our word for it. Explore how artists earn and fans discover music on our platform.
          </p>
        </div>
