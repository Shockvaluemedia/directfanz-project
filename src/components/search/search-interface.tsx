      ...
      <div className='p-6'>
        <div className='flex items-start justify-between'>
          <div className='flex-1'>
            ...
            {item.creator && (
              <p className='text-sm text-gray-600 mb-2'>by {item.creator.displayName}</p>
            )}
            {item.description && (
          ...
          <div className='ml-4 text-right'>
            ...
            {item.price && <p className='text-lg font-bold text-gray-900 mt-2'>${item.price}</p>}
          </div>
        </div>
  ...
  return (
    <div className='min-h-screen bg-gray-50'>
      <div className='max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8'>
        {/* Search Header */}
        <div className='mb-8'>
          <h1 className='text-3xl font-bold text-gray-900 mb-6'>Discover Artists & Content</h1>
