...
export function AdvancedAnalyticsDashboard({ className }: AdvancedAnalyticsDashboardProps) {
  ...
  const mockAnalytics: AnalyticsData = {
    ...
    timeSeriesData: Array.from({ length: 30 }, (_, i) => ({
      ...
      views: Math.floor(crypto.getRandomValues(new Uint32Array(1))[0] / (0xffffffff + 1) * 5000) + 2000,
      uniqueViews: Math.floor(crypto.getRandomValues(new Uint32Array(1))[0] / (0xffffffff + 1) * 2000) + 800,
      revenue: Math.floor(crypto.getRandomValues(new Uint32Array(1))[0] / (0xffffffff + 1) * 500) + 200,
      subscribers: Math.floor(crypto.getRandomValues(new Uint32Array(1))[0] / (0xffffffff + 1) * 50) + 20,
      engagement: Math.floor(crypto.getRandomValues(new Uint32Array(1))[0] / (0xffffffff + 1) * 20) + 5
    })),
    contentPerformance: [
      { id: '1', title: 'Latest Music Video', type: 'video', views: 25432, engagement: 12.3, revenue: 2843, conversionRate: 8.2 },
      { id: '2', title: 'Behind the Scenes', type: 'video', views: 18765, engagement: 9.8, revenue: 1432, conversionRate: 6.1 },
      { id: '3', title: 'Exclusive Photo Set', type: 'image', views: 15432, engagement: 15.2, revenue: 987, conversionRate: 4.3 },
      { id: '4', title: 'New Single Preview', type: 'audio', views: 12876, engagement: 18.7, revenue: 1654, conversionRate: 9.8 },
      { id: '5', title: 'Live Stream Recording', type: 'video', views: 9876, engagement: 11.4, revenue: 765, conversionRate: 3.2 }
    ],
    audienceInsights: {
      demographics: {
        ageGroups: [
      ...
      behavior: {
        ...
        peakHours: Array.from({ length: 24 }, (_, i) => ({
          hour: i,
          activity: Math.floor(crypto.getRandomValues(new Uint32Array(1))[0] / (0xffffffff + 1) * 100) + 20
        }))
      }
    },
    revenueBreakdown: {
      subscriptions: 8943.50,
      tips: 2432.00,
      merchandise: 1236.00,
      other: 232.00
    }
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">{formatNumber(displayData.overview.totalViews)}</p>
              </div>
            ...
            <div className="flex items-center mt-2">
              ...
              <span className={`text-sm ml-1 ${displayData.overview.growthRate >= 0 ? 'text-green-500' : 'text-red-500'}`}>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">{formatNumber(displayData.overview.uniqueViewers)}</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">{formatCurrency(displayData.overview.totalRevenue)}</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">{formatNumber(displayData.overview.activeSubscribers)}</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">{displayData.audienceInsights.behavior.avgSessionDuration}m</p>
              </div>
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <PieChart>
                    <Pie
                      data={[
                        { name: 'Subscriptions', value: displayData.revenueBreakdown.subscriptions },
