        ...
        <div className="mb-12">
          ...
          {campaigns.length === 0 ? (
            <div className="bg-white rounded-lg p-8 text-center shadow">
              ...
              <p className="text-gray-600 mb-4">Join artist campaigns to showcase your creativity</p>
              <Link 
                href="/campaigns"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {campaigns.map((campaign) => (
                <div key={campaign.id} className="bg-white rounded-lg p-6 shadow hover:shadow-md transition-shadow">
