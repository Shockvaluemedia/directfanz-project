      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
            Join thousands of creators who have already transformed their passion into sustainable
            income
          </p>
        </div>
        ...
        <div className='grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16'>
          <StatCard value={25000} label='Active Creators' suffix='+' />
          <StatCard value={1200000} label='Monthly Content Views' suffix='+' />
          <StatCard value={2800} label='Average Monthly Creator Earnings' prefix='$' />
          <StatCard value={95} label='Creator Retention Rate' suffix='%' />
        </div>
