            ...
            return (
              <div
                ...
                className={`flex items-center gap-3 p-3 cursor-pointer transition-colors ${
                  isCurrentItem ? 'bg-blue-50 border-l-4 border-blue-500' : 'hover:bg-gray-50'
                }`}
              ...
              >
                ...
                <div className='text-right flex-shrink-0'>
                  ...
                  {item.duration && (
                    <div className={`text-xs ${isCurrentItem ? 'text-blue-600' : 'text-gray-500'}`}>
        ...
        <div className='border-t border-gray-200 p-3 bg-gray-50'>
          <div className='flex items-center justify-between'>
            <div className='flex items-center gap-3'>
              ...
              <button
                ...
                className={`p-2 rounded-full ${
                  shuffleMode ? 'bg-blue-100 text-blue-600' : 'text-gray-500 hover:bg-gray-100'
                }`}
            ...
            <div className='flex justify-between text-xs text-gray-500'>
              ...
              <span className='ml-3'>
                Total:{' '}
                {items.reduce((acc, item) => acc + (item.duration || 0), 0) > 0
