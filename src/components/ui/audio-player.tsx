...
export default function AudioPlayer({ 
  ...
  const handleKeyDown = useCallback((e: React.KeyboardEvent) => {
    ...
    if (['Space', 'ArrowLeft', 'ArrowRight', 'ArrowUp', 'ArrowDown', 'm', 'p', 'n'].includes(e.key)) {
      e.preventDefault();
    }
  ...
  }, [togglePlayPause, seekTo, currentTime, duration, changeVolume, volume, toggleMute, playPrevious, playNext, trackIndex, tracks.length]);
  ...
  }, [isLoading, error, isPlaying, currentTrack]);
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        {/* Control Buttons */}
        <div className="flex items-center justify-center gap-4" role="toolbar" aria-label="Audio controls">
          {/* Previous Track */}
          <button
