# Enhanced IAM Roles and Policies for DirectFanz AWS Infrastructure
...
# Enhanced ECS Task Role with additional permissions
resource "aws_iam_role_policy" "ecs_task_enhanced_policy" {
  name = "${var.project_name}-ecs-task-enhanced-policy"
...
# Application Auto Scaling Role for ECS
