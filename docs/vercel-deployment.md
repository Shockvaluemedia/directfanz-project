# 🚀 Vercel Deployment Guide for DirectFanz

## Overview

This guide walks you through deploying your DirectFanz to Vercel with
...
3. Click "Add Domain"
4. Enter your domain (e.g., `directfanz.io`)
...
2. Update endpoint URL to: `https://directfanz.io/api/webhooks/stripe`
...
- Verify HTTPS works: `https://directfanz.io`
...
**🎉 Congratulations! Your DirectFanz is now live in production!**
