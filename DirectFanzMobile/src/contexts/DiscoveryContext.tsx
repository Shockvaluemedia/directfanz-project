...
const STORAGE_KEYS = {
  USER_PREFERENCES: '@directfanz_discovery_user_preferences',
  VIEWING_HISTORY: '@directfanz_discovery_viewing_history', 
  SEARCH_HISTORY: '@directfanz_discovery_search_history',
  CONTENT_CACHE: '@directfanz_discovery_content_cache',
  FOLLOWED_CREATORS: '@directfanz_discovery_followed_creators',
  ENGAGEMENT: '@directfanz_discovery_engagement',
  SEARCH_FILTERS: '@directfanz_discovery_search_filters',
} as const;
